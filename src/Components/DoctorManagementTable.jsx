...
const DoctorManagementTable = () => {
  ...
  useEffect(() => {
    const fetchDoctorData = async () => {
      try {
        const response = await fetch("https://backend-1-ripd.onrender.com/admin/alldoctors", {
          method: "GET",
          credentials: "include",
        });
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const response = await axios.delete(`https://backend-1-ripd.onrender.com/admin/deletedoctor/${selectedDoctorId}`, {
        headers: {
